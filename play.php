...
<head>
<title><?php $name = str_replace('_', ' ', $_REQUEST["c"]); echo $name; ?> | [L_S_MENA]</title>
...
<div class="loading-text">
    <span class="loading-text-words text-dander">L</span>
    <span class="loading-text-words text-info">_</span>
    <span class="loading-text-words text-warning">S</span>
    <span class="loading-text-words text-success">_</span>
    <span class="loading-text-words text-light">M</span>
    <span class="loading-text-words text-primary">E_E</span>
    <span class="loading-text-words text-warning">N</span>
    <span class="loading-text-words text-success">A</span>
</div>
</div>
